...
public class GamePanel extends JPanel implements ActionListener {
    ...
    static final int GAME_UNTIS = (SCREEN_WIDTH * SCREN_HEIGHT) / UNIT_SIZE;
    ...
    GamePanel() {
        random = new Random();
        this.setPreferredSize(new Dimension(SCREEN_WIDTH, SCREN_HEIGHT));
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Game Over", (SCREEN_WIDTH - metrics1.stringWidth("Game Over")) / 2, SCREN_HEIGHT / 2);
        g.setColor(Color.red);
        g.setFont(new Font("Ink Free", Font.BOLD, 40));
